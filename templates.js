...
exports.sanctionLetterHTMLContent = void 0;
const date_fns_1 = require("date-fns");
const utils_1 = require("./utils");
const sanctionLetterHTMLContent = ({ logoUrl, customerName, applicationId, approvalDate, approvalAmount, roi, processingFees, gstAmount, totalDeductions, disbursalAmount, repayDate, repayAmount, clientName, clientNbfc, }) => {
                                            ...
                                            <table style="width:100%; border-collapse:collapse; margin-top:10px;">
                                              ...
                                              <tbody>
                                                ...
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;"> ${(0, date_fns_1.format)(approvalDate, 'do MMM yyyy')}</td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;"> ${(0, utils_1.formatIndianNumber)(approvalAmount)}</td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                ...
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;">${(0, utils_1.formatIndianNumber)(processingFees)}</td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;">${(0, utils_1.formatIndianNumber)(gstAmount)}</td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;">${(0, utils_1.formatIndianNumber)(totalDeductions)} </td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;"> ${(0, utils_1.formatIndianNumber)(disbursalAmount)}</td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;">${(0, date_fns_1.format)(repayDate, 'dd-MM-yyyy')} </td>
                                                </tr>
                                                <tr style="border:1px solid #ddd;">
                                                  ...
                                                  <td style="border-left:2px solid #ddd; paddingLeft: 4px;">${(0, utils_1.formatIndianNumber)(repayAmount)} </td>
                                                </tr>
                                              </tbody>
                                            </table>
...
exports.sanctionLetterHTMLContent = sanctionLetterHTMLContent;

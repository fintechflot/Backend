...
import  eMandateModel from './e-manadate.model'
...
async function eMandate(req: Request, res: Response,next:NextFunction): Promise<void> {
    try {
      ...
      const panRes = await eMandateModel.getPanDetails(panNumber);
